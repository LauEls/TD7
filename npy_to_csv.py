...
for i in range(5):
    ...
    file_base_path = "runs/door_mirror/gh360/osc_pose/online/v18_rl_without_demo_full_length/run_"+str(i)
    # file_base_path = "runs/door_mirror/gh360/osc_pose/offline/v4_medium_expert_paths_full_length/run_"+str(i)
