...
exp_1_raw = readmatrix(td7_file_base+"v8_corl_with_demos/run_0/results.csv");
exp_2_raw = readmatrix(td7_file_base+"v8_corl_with_demos/run_1/results.csv");
exp_3_raw = readmatrix(td7_file_base+"v8_corl_with_demos/run_2/results.csv");
...
exp_1_mean = exp_1_mean/130;
exp_2_mean = exp_2_mean/130;
exp_3_mean = exp_3_mean/130;
...
td7_x_values = (0:10*130/1000:130*200/1000);
% td7_x_values2 = (0:10*130:130*120);
...
exp_1_trans = [transpose(exp_2_mean); transpose(exp_3_mean)];
...
plot_areaerrorbar(exp_1_trans, options_3);
%plot_areaerrorbar(exp_2_trans, options_5);
...
% xlim([0 0.5])
ylim([0 1])
lgd = legend('', 'RL with demonstration buffer', 'Location','best');
%lgd.NumColumns = 3;
