...
rl_with_demo_run_0_mean = mean(rl_with_demo_run_0_raw,2);
rl_with_demo_run_1_mean = mean(rl_with_demo_run_1_raw,2);
rl_with_demo_run_2_mean = mean(rl_with_demo_run_2_raw,2);
rl_with_demo_run_3_mean = mean(rl_with_demo_run_3_raw,2);
rl_with_demo_run_4_mean = mean(rl_with_demo_run_4_raw,2);
...
rl_with_demo_run_2_mean = rl_with_demo_run_2_mean/episode_length;
rl_with_demo_run_3_mean = rl_with_demo_run_3_mean/episode_length;
rl_with_demo_run_4_mean = rl_with_demo_run_4_mean/episode_length;
